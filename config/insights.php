...
use PHP_CodeSniffer\Standards\PEAR\Sniffs\WhiteSpace\ScopeClosingBraceSniff as PearScopeClosingBraceSniff;
...
return [
    ...
    */
    ...
    'remove' => [
        ...
        PearScopeClosingBraceSniff::class,
    ...
    'config' => [
        ...
        ClassMethodAverageCyclomaticComplexityIsHigh::class => [
            'maxClassMethodAverageComplexity' => 6,
        ],
